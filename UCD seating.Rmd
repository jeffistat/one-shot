...
UC Davis with mulitple variables out of 173 students. It waS A observation study because the subject were just observed in there natural habitats. 
...
for this question  !--> 
Both variables are categorical in this data. We will use graphs to display the knowlendge we learn in  the previous classes. The vaiables that we are focusing on are major(liberal or non liberal) and seat (front,back or middle). I used a bar graph to indicate the data.
